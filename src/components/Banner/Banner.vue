        ...
        <div class="container">
            <div class="row">
              <div class="col-xs-12 col-md-12">
                  <div class="bunner__container" style="background-image: url('images/aob.jpg');background-size: cover;background-repeat: no-repeat;">
...
<style src="./Banner.sass" lang="sass"></style>
